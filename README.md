...
**React on Rails** is a full stack ruby-on-rails-react web application on a postgreSQL database that is built to display a random greeting to a user.
...
- **API that displays a random greeting**
...
```sh
  cd [my-folder]
  git clone git@github.com:amon-cofie/react-on-rails.git
  cd react-on-rails
```
